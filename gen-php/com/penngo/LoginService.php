...
class LoginServiceClient implements \com\penngo\LoginServiceIf {
  ...
  {
    $args = new \com\penngo\LoginService_login_args();
    $args->name = $name;
    $args->psw = $psw;
  ...
  public function recv_login()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\com\penngo\LoginService_login_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \com\penngo\LoginService_login_result();
...
class LoginServiceProcessor {
  ...
  protected function process_login($seqid, $input, $output) {
    ...
    $input->readMessageEnd();
    $result = new \com\penngo\LoginService_login_result();
    $result->success = $this->handler_->login($args->name, $args->psw);
