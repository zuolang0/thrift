...
class HelloWorldClient implements \hello\HelloWorldIf {
  ...
  public function send_sayHello()
  {
    $args = new \hello\HelloWorld_sayHello_args();
  ...
  public function recv_sayHello()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\hello\HelloWorld_sayHello_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \hello\HelloWorld_sayHello_result();
...
class HelloWorldProcessor {
  ...
  protected function process_sayHello($seqid, $input, $output) {
    ...
    $input->readMessageEnd();
    $result = new \hello\HelloWorld_sayHello_result();
    $result->success = $this->handler_->sayHello();
