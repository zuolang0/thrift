...
class Client(Iface):
    ...
    def send_EditName(self, id, name):
        self._oprot.writeMessageBegin('EditName', TMessageType.CALL, self._seqid)
        args = EditName_args()
        args.id = id
        args.name = name
    ...
    def recv_EditName(self):
        ...
        raise TApplicationException(TApplicationException.MISSING_RESULT, "EditName failed: unknown result")
