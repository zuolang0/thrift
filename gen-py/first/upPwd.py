...
class Client(Iface):
    ...
    def EditPassword(self, id, password):
        ...
        Parameters:
         ...
         - password
        """
        self.send_EditPassword(id, password)
        return self.recv_EditPassword()

    def send_EditPassword(self, id, password):
    ...
    def recv_EditPassword(self):
        ...
        raise TApplicationException(TApplicationException.MISSING_RESULT, "EditPassword failed: unknown result")
...
class Processor(Iface, TProcessor):
    ...
    def process_EditPassword(self, seqid, iprot, oprot):
        ...
        result = EditPassword_result()
        try:
            result.success = self._handler.EditPassword(args.id, args.password)
